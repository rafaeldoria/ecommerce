...
return [
    ...
    'checkout' => [
        'title' => 'Checkout',
        'foundation_note' => 'O checkout coleta apenas email e WhatsApp antes de enviar voce para o pagamento seguro.',
        'empty_description' => 'Adicione um item disponivel ao carrinho antes de iniciar o pagamento.',
        'contact_title' => 'Dados para iniciar o pagamento',
        'contact_note' => 'Usaremos estes dados para criar seu pedido pendente e abrir o Checkout Pro.',
        'email_label' => 'Email',
        'whatsapp_label' => 'WhatsApp',
        'complete_purchase' => 'Concluir compra',
        'trust_note' => 'O pagamento e processado pelo Mercado Pago. A equipe faz o fulfillment manual depois que a confirmacao do pagamento chega com seguranca.',
    ],
    'payment_return' => [
        ...
        'reference_note' => 'Guarde esta referencia se precisar falar com o suporte.',
        'back_to_cart' => 'Voltar ao carrinho',
        'support_cta' => 'Falar com suporte',
        'success' => [
            'title' => 'Pagamento enviado para confirmacao',
            'description' => 'Recebemos o retorno do Mercado Pago. A confirmacao final acontece pelo webhook seguro antes do fulfillment manual.',
        ],
        'failure' => [
            'title' => 'Pagamento nao concluido',
            'description' => 'O Mercado Pago indicou que a tentativa nao foi concluida. Se o valor aparecer no seu banco, fale com o suporte antes de tentar novamente.',
        ],
        'pending' => [
            'title' => 'Pagamento em analise',
            'description' => 'Alguns pagamentos levam mais tempo para confirmar. O pedido permanece pendente ate recebermos a verificacao segura do Mercado Pago.',
        ],
    ],
    'content' => [
