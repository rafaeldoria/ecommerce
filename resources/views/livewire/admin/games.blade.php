                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-wrap justify-end gap-2">
                                <a class="rounded-lg border border-zinc-700 px-3 py-2 text-sm font-medium text-zinc-100 transition hover:border-zinc-500 hover:bg-zinc-800" href="{{ route('admin.games.edit', ['game' => $game]) }}">
